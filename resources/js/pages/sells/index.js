...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Create guest modal
    const createGuestModalElement = document.getElementById("sell-modal");
    const GuestModal = new Modal(createGuestModalElement, overlayElement);

    // Button to enable create guest modal
    const createGuestButton = document.getElementById("create-sell-button");
    ...
    const productTableElement = document.getElementById("products");
    const ProductsTable = new Table(productTableElement, "users");

<div
    {{ $attributes->merge(['class' => 'bg-white shadow-lg dark:bg-zinc-800 border dark:border-zinc-700 border-none rounded-lg shadow-md p-4']) }}>
    <div class="flex items-center gap-3">
        <x-dynamic-component :component="'icons.' . $icon" class="bg-rose-500/20 p-4 text-xl text-rose-500 rounded-lg" />
    ...
    <div class="w-full bg-neutral-300/50 dark:bg-zinc-700/50 rounded-full h-2 mt-1">
        <div class="bg-rose-500 h-2 rounded-full" style="width: {{ $porcent }}%;"></div>
    </div>
</div>

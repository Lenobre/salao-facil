        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-rose-50: oklch(.962 .018 272.314);
                    --color-rose-100: oklch(.93 .034 272.788);
                    --color-rose-200: oklch(.87 .065 274.039);
                    --color-rose-300: oklch(.785 .115 274.713);
                    --color-rose-400: oklch(.673 .182 276.935);
                    --color-rose-500: oklch(.585 .233 277.117);
                    --color-rose-600: oklch(.511 .262 276.966);
                    --color-rose-700: oklch(.457 .24 277.023);
                    --color-rose-800: oklch(.398 .195 277.366);
                    --color-rose-900: oklch(.359 .144 278.697);
                    --color-rose-950: oklch(.257 .09 281.288);
